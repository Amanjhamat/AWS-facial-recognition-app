...
function App() {
  ...
  function sendImage(e){
    ...
    fetch(`https://ip775mtl2m.execute-api.us-east-1.amazonaws.com/dev/visitors-images/${visitorImageName}.jpeg` ,{
  ...
  async function authenticate(visitorImageName){
    const requestUrl='https://ip775mtl2m.execute-api.us-east-1.amazonaws.com/dev/employee?'+new URLSearchParams({
